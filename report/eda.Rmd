...
To continue with our analysis we decided to applied a Chi-square test of independence between Apple's and Samsung's reviews.
...
Smartphone_reviews.dfm2 <- dfm(Smartphone_reviews.tk2)

summary(Smartphone_reviews.cp)
## showing terms

tstat1 <- textstat_keyness(Smartphone_reviews.dfm2, target = "Samsung")
head(tstat1, 10)
