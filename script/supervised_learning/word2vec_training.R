...
# # Save the model
write.word2vec(all_model, here::here("script/supervised_learning/models/all_model.bin"))
write.word2vec(apple_model, here::here("script/supervised_learning/models/apple_model.bin"))
write.word2vec(samsung_model, here::here("script/supervised_learning/models/samsung_model.bin"))
