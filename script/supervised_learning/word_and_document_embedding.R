...
source(here::here("script/supervised_learning/document_embedding_function.R"))
library(uwot)
library(ggrepel)
library(plotly)
library(ClusterR)
...
# # Read models
all_model <- read.word2vec(here::here("script/supervised_learning/models/all_model.bin"))
apple_model <- read.word2vec(here::here("script/supervised_learning/models/apple_model.bin"))
samsung_model <- read.word2vec(here::here("script/supervised_learning/models/samsung_model.bin"))
